 ...
 */
package com.helger.numbercruncher.program4_6;
...
/**
 * PROGRAM 4-6: Fraction Sum 10M with Randomized Order Compute the sum 1/d + 2/d + 3/d + ... + n/d =
 * d/d where: n = 10,000,000 d = 1 + 2 + 3 + ... + n = (n/2)(n + 1) Randomize the order of the
 * fractions, and then compute their sum by simple straight summation and by Kahan's Summation
 * Algorithm.
 */
 ...
 * 500000 0.03253527 0 1000000 0.06698631 0 1500000 0.10321888 1 2000000 0.14138556 1 2500000
 * 0.18116862 2 3000000 0.22312914 2 3500000 0.26563966 3 4000000 0.31117648 4 4500000 0.35919634 4
 * 5000000 0.40717205 4 5500000 0.45824587 4 6000000 0.5116293 5 6500000 0.5648118 9 7000000
 * 0.6180561 9 7500000 0.67235166 9 8000000 0.73646766 9 8500000 0.8006135 9 9000000 0.8647307 9
 * 9500000 0.9288819 9 10000000 0.9929972 9 Straight summation % error = 0.7002771 KAHAN SUMMATION
 * ALGORITHM: i Running sum % ExpDiff>24 ----------------------------------------- 500000
 * 0.032521274 0 1000000 0.06689266 0 1500000 0.10307682 1 2000000 0.14115047 1 2500000 0.18101728 2
 * 3000000 0.22275041 2 3500000 0.26629776 3 4000000 0.31170923 4 4500000 0.35897893 4 5000000
 * 0.40804166 4 5500000 0.45892397 4 6000000 0.51166385 5 6500000 0.566273 9 7000000 0.6227702 9
 * 7500000 0.68106335 9 8000000 0.74115884 9 8500000 0.8031232 9 9000000 0.86690027 9 9500000
 * 0.9325508 9 10000000 1.0 9 Kahan summation % error = 0.0
 */
