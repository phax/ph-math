 ...
 */
package com.helger.numbercruncher.program4_3;

import com.helger.numbercruncher.mathutils.SystemOutAlignRight;

/**
 * PROGRAM 4-3: Fraction Sum 100M in the Reversed Order Compute the sum n/d + (n-1)/d + (n-2)/d +
 * ... + 2/d + 1/d = d/d where: n = 100,000,000 d = 1 + 2 + 3 + ... + n = (n/2)(n + 1) See if the
 * sum is closer to 1.
 */
 ...
 * --------------------------------------------------------------------- 95000001 1.9E-8 0.10206167
 * 0 0 90000001 1.8E-8 0.18421358 22 0 85000001 1.7E-8 0.26743877 23 0 80000001 1.6E-8 0.41645038 24
 * 0 75000001 1.5E-8 0.5 24 43 70000001 1.3999999E-8 0.5 25 100 65000001 1.2999999E-8 0.5 26 100
 * 60000001 1.2E-8 0.5 26 100 55000001 1.1E-8 0.5 26 100 50000001 1.0E-8 0.5 26 100 45000001 9.0E-9
 * 0.5 26 100 40000001 8.0E-9 0.5 26 100 35000001 6.9999997E-9 0.5 26 100 30000001 6.0E-9 0.5 27 100
 * 25000001 5.0E-9 0.5 27 100 20000001 4.0E-9 0.5 27 100 15000001 3.0E-9 0.5 27 100 10000001
 * 2.0000002E-9 0.5 28 100 5000001 1.0000002E-9 0.5 28 100 1 1.9999999E-16 0.5 29 100
 */
