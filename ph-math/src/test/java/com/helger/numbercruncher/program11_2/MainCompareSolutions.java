...
/**
 * PROGRAM 11-2: Compare Solution Algorithms Compare algorithms for solving a system of linear
 * equations.
 */
...
/*
 * Output: Coefficient matrix A Row 1: 3.0 1.0 -5.0 4.0 Row 2: 2.0 -3.0 3.0 -2.0 Row 3: 5.0 -3.0 4.0
 * 1.0 Row 4: -2.0 4.0 -3.0 -5.0 b = -18.0 19.0 22.0 -14.0 LU decomposition: x = 1.0 -2.0 3.0 -1.0
 * Error vector norm = 0.0 A inverse Row 1: 0.08121827 -0.02538071 0.20812182 0.11675127 Row 2:
 * -0.12436548 -0.49238577 0.33756346 0.16497461 Row 3: -0.19035533 -0.28426397 0.23096447
 * 0.007614213 Row 4: -0.017766498 -0.21319798 0.04822335 -0.11928934 Multiplication by inverse: x =
 * 0.9999999 -1.9999995 2.9999998 -1.0000004 Error vector norm = 6.529362E-7 Determinant of A =
 * 394.00003 Condition number of A = 11.255114 A[1], determinant = 393.99997 Row 1: -18.0 1.0 -5.0
 * 4.0 Row 2: 19.0 -3.0 3.0 -2.0 Row 3: 22.0 -3.0 4.0 1.0 Row 4: -14.0 4.0 -3.0 -5.0 A[2],
 * determinant = -787.99994 Row 1: 3.0 -18.0 -5.0 4.0 Row 2: 2.0 19.0 3.0 -2.0 Row 3: 5.0 22.0 4.0
 * 1.0 Row 4: -2.0 -14.0 -3.0 -5.0 A[3], determinant = 1182.0 Row 1: 3.0 1.0 -18.0 4.0 Row 2: 2.0
 * -3.0 19.0 -2.0 Row 3: 5.0 -3.0 22.0 1.0 Row 4: -2.0 4.0 -14.0 -5.0 A[4], determinant = -394.00003
 * Row 1: 3.0 1.0 -5.0 -18.0 Row 2: 2.0 -3.0 3.0 19.0 Row 3: 5.0 -3.0 4.0 22.0 Row 4: -2.0 4.0 -3.0
 * -14.0 Cramer's rule: x = 0.9999998 -1.9999996 2.9999998 -1.0 Error vector norm = 4.6552717E-7
 */
