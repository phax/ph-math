...
public interface IMutableBaseGraphRelation <N extends IMutableBaseGraphNode <N, R>, R extends IMutableBaseGraphRelation <N, R>> extends IMutableBaseGraphObject
{
  /**
